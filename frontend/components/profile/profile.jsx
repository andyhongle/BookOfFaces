            ...
            editButton = (
                <button className="edit-profile-button">
                    <a
                        ...
                        href={`#/users/${this.props.profileUser.id}/edit`}
                    >
                        <img src={editURL} />
            ...
            <div className="profile">
                <div className="profile-header">
                    <img
                        ...
                        src={this.props.profileUser.cover_photo}
                    />
                    <div className="profile-picture-button-container">
                        <img
                            className="profile-photo"
                            src={this.props.profileUser.profile_photo}
                        />
                    </div>
                ...
                <div className="profile-main">
                    <div className="intro-container">
                        ...
                        <div className="education-container">
                            ...
                            <div className="intro-info">
                                {this.props.profileUser.education}
                            </div>
                        </div>
                        <div className="hometown-container">
                            ...
                            <div className="intro-info">
                                {this.props.profileUser.hometown}
                            </div>
                        </div>
                        <div className="pronunciation-container">
                            ...
                            <div className="intro-info">
                                {this.props.profileUser.pronunciation}
                            </div>
                        </div>
                    </div>
                    <div className="right-wall">
                        <WallPostFormContainer />
                        <div className="posts-blocker">
                            <div>Posts</div>
                        </div>
                        <WallPostContainer />
                    </div>
